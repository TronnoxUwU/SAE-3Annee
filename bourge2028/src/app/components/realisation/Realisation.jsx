...
export default function ProjetView({ id, type }) {
  ...
  const canEdit = () => {
    if (!session || !collaborateurs.length) return false;
    ...
    <div className={Style.userPage}>
      ...
      {(articles.length > 0 || canEdit()) && (
        <section className={Style.section}>
          <h2 className={Style.sectionTitle}>À propos de ce projet</h2>
      ...
      {collaborateurs.length > 0 && (
        <section className={Style.section}>
          <h2 className={Style.sectionTitle}>Les collaborateurs</h2>
